...
public class PBModItems {
    ...
    public static final RegistryObject<Item> IRON_AXE =
            ITEMS.register("iron_axe", () -> new IronAxeItem(new Item.Properties()));

    public static final RegistryObject<Item> IRON_SHOVEL =
            ITEMS.register("iron_shovel", () -> new IronShovelItem(new Item.Properties()));

    public static final RegistryObject<Item> IRON_HOE =
    ...
    public static final RegistryObject<Item> IRON_BATTLEHAMMER =
            ITEMS.register("iron_battlehammer", () -> new IronBattleHammerItem(new Item.Properties()));

    public static final RegistryObject<Item> IRON_BATTLESCYTHE =
    ...
    public static final RegistryObject<Item> IRON_CLAWS =
    ...
    public static final RegistryObject<Item> GOLDEN_AXE =
            ITEMS.register("golden_axe", () -> new GoldenAxeItem(new Item.Properties()));

    public static final RegistryObject<Item> GOLDEN_SHOVEL =
            ITEMS.register("golden_shovel", () -> new GoldenShovelItem(new Item.Properties()));

    public static final RegistryObject<Item> GOLDEN_HOE =
    ...
    public static final RegistryObject<Item> GOLDEN_BATTLEHAMMER =
            ITEMS.register("golden_battlehammer", () -> new GoldenBattleHammerItem(new Item.Properties()));

    public static final RegistryObject<Item> GOLDEN_BATTLESCYTHE =
    ...
    public static final RegistryObject<Item> GOLDEN_CLAWS =
    ...
    public static final RegistryObject<Item> DIAMOND_AXE =
            ITEMS.register("diamond_axe", () -> new DiamondAxeItem(new Item.Properties()));

    public static final RegistryObject<Item> DIAMOND_SHOVEL =
            ITEMS.register("diamond_shovel", () -> new DiamondShovelItem(new Item.Properties()));

    public static final RegistryObject<Item> DIAMOND_HOE =
    ...
    public static final RegistryObject<Item> DIAMOND_BATTLEHAMMER =
            ITEMS.register("diamond_battlehammer", () -> new DiamondBattleHammerItem(new Item.Properties()));

    public static final RegistryObject<Item> DIAMOND_BATTLESCYTHE =
    ...
    public static final RegistryObject<Item> DIAMOND_CLAWS =
    ...
    public static final RegistryObject<Item> NETHERITE_BATTLEHAMMER =
            ITEMS.register("netherite_battlehammer", () -> new NetheriteBattleHammerItem(new Item.Properties()));

    public static final RegistryObject<Item> NETHERITE_BATTLESCYTHE =
    ...
    public static final RegistryObject<Item> NETHERITE_STAFF =
    ...
    public static final RegistryObject<Item> NETHERITE_CLAWS =
    ...
    public static final RegistryObject<Item> DEMON_CLAWS =
            ITEMS.register("demon_claws", () -> new DemonClawsItem(new Item.Properties()));

    public static final RegistryObject<Item> DEMON_TACHI =
            ITEMS.register("demon_tachi", () -> new DemonTachiItem(new Item.Properties()));


    //SPECIAL
    public static final RegistryObject<Item> ARCLIGHT_SWORD =
            ITEMS.register("arclight_sword", () -> new ArclightSwordItem(new Item.Properties()));

    public static final RegistryObject<Item> FROZEN_DEBUFF_ICE_BLOCK =
