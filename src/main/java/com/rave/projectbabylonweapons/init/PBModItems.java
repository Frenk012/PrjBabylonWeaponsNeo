...
public class PBModItems {
    public static final DeferredRegister.Items ITEMS =
            DeferredRegister.createItems(ProjectBabylonWeapons.MODID);

    public static final DeferredItem<Item> FIRE_SPELL_PROJECTILE =
    ...
    public static final DeferredItem<Item> IRON_CLAWS =
            ITEMS.register("iron_claws", () -> new IronClawsItem(new Item.Properties()));

    public static final DeferredItem<Item> IRON_TACHI =
            ITEMS.register("iron_tachi", () -> new IronTachiItem(new Item.Properties()));

    public static final DeferredItem<Item> IRON_BATTLE_WAND =
    ...
    public static final DeferredItem<Item> GOLDEN_SHORTSWORD =
            ITEMS.register("golden_shortsword", () -> new GoldenShortswordItem(new Item.Properties()));

    public static final DeferredItem<Item> GOLDEN_LONGSWORD =
            ITEMS.register("golden_longsword", () -> new GoldenLongswordItem(new Item.Properties()));

    public static final DeferredItem<Item> GOLDEN_GREATSWORD =
    ...
    public static final DeferredItem<Item> GOLDEN_CLAWS =
            ITEMS.register("golden_claws", () -> new GoldenClawsItem(new Item.Properties()));

    public static final DeferredItem<Item> GOLDEN_TACHI =
            ITEMS.register("golden_tachi", () -> new GoldenTachiItem(new Item.Properties()));

    public static final DeferredItem<Item> GOLDEN_BATTLE_WAND =
    ...
    public static final DeferredItem<Item> DIAMOND_AXE =
