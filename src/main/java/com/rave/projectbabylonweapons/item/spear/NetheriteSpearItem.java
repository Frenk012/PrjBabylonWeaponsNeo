...
public class NetheriteSpearItem extends SwordItem {
    ...
    public static final int DURABILITY = 3308;
    ...
    public static final float BRIMSTONE_FLAMES_PROC_CHANCE = 0.30F;
    public static final int BRIMSTONE_FLAMES_DURATION_TICKS = 20 * 6;

    public static final float BRIMSTONE_FIRE_PROC_CHANCE = 0.30F;
    ...
    public NetheriteSpearItem(Properties props) {
