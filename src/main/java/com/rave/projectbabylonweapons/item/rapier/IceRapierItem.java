...
public class IceRapierItem extends SwordItem {
    ...
    public static final float CHILL_I_PROC_CHANCE = 0.40F;
    public static final float CHILL_II_PROC_CHANCE = 0.40F;
    public static final float CHILL_III_PROC_CHANCE = 0.40F;
    public static final float FROZEN_FROM_CHILL_III_PROC_CHANCE = 0.40F;
