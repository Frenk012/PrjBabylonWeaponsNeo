...
public class NetheriteStaffItem extends SwordItem {


    public static final int DURABILITY = 3220;
    ...
    public static final float BRIMSTONE_FLAMES_PROC_CHANCE = 0.20F;
    public static final int BRIMSTONE_FLAMES_DURATION_TICKS = 20 * 5;

    public static final float BRIMSTONE_FIRE_PROC_CHANCE = 0.20F;
    ...
    public NetheriteStaffItem(Properties props) {
