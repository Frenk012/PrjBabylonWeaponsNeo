...
import com.rave.projectbabylonweapons.item.model.IronBattleWandItemModel;
...
public class IronBattleWandItemRenderer extends GeoItemRenderer<IronBattleWandItem> {
    ...
    protected IronBattleWandItem animatable;
    private final Set<String> hiddenBones = new HashSet<>();
    private final Set<String> suppressedBones = new HashSet<>();

    public IronBattleWandItemRenderer() {
        super(new IronBattleWandItemModel());
    }

    @Override
    public RenderType getRenderType(IronBattleWandItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    @Override
    public ResourceLocation getTextureLocation(IronBattleWandItem instance) {
