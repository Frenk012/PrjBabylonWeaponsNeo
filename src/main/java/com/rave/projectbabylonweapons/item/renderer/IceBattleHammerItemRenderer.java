...
import com.rave.projectbabylonweapons.item.model.IceBattleHammerItemModel;
...
public class IceBattleHammerItemRenderer extends GeoItemRenderer<IceBattleHammerItem> {
    ...
    protected IceBattleHammerItem animatable;
    private final Set<String> hiddenBones = new HashSet<>();
    private final Set<String> suppressedBones = new HashSet<>();

    public IceBattleHammerItemRenderer() {
        super(new IceBattleHammerItemModel());
    }

    @Override
    public RenderType getRenderType(IceBattleHammerItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    @Override
    public ResourceLocation getTextureLocation(IceBattleHammerItem instance) {
