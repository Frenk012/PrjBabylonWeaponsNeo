...
public class IronClawsItem extends SwordItem {

    // РС‚РѕРі: СѓСЂРѕРЅ 4.0, СЃРєРѕСЂРѕСЃС‚СЊ 3.4, РїСЂРѕС‡РЅРѕСЃС‚СЊ 460.
    public static final int   DURABILITY = 820;
    ...
    public IronClawsItem(Properties props) {
