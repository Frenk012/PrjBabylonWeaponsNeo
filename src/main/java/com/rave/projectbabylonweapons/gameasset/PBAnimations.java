...
//SKILLS
    ...
    public static AnimationManager.AnimationAccessor<ActionAnimation> BLESSING;
...
//WAND
        ...
        })).addProperty(AnimationProperty.AttackPhaseProperty.DAMAGE_MODIFIER, ValueModifier.multiplier(1.5F)).addProperty(AnimationProperty.AttackPhaseProperty.PARTICLE, EpicFightParticles.EVISCERATE).addProperty(AnimationProperty.AttackAnimationProperty.BASIS_ATTACK_SPEED, 1.3F));
...
//SKILLS
        ...
        BLESSING= builder.nextAccessor("biped/skill/blessing", (accessor) -> new ActionAnimation(0.25F, accessor, Armatures.BIPED).addProperty(AnimationProperty.ActionAnimationProperty.STOP_MOVEMENT, true));
